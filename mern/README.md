...
├── [codemorph/](./codemorph/)
├── [component-usage-scanner/](./component-usage-scanner/)
...
├── [envguard/](./envguard/)
├── [envrunes/](./envrunes/)
├── [error-translator/](./error-translator/)
├── [eventforge/](./eventforge/)
├── [eventmesh/](./eventmesh/)
├── [feature-slice-forge/](./feature-slice-forge/)
├── [fileflux/](./fileflux/)
├── [flagmesh/](./flagmesh/)
...
| --- | --- | --- | --- |
| [adminforgex](./adminforge/) | [README](./adminforge/README.md) · [src](./adminforge/src/) | `admin` · `adminforgex` · `crud` · `dashboard` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · _+3_ | adminforgex — Admin panel generator core: JSON manifest of models, fields, and routes for CRUD UIs ( |
...
| [auth-launcher](./auth-launcher/) | [README](./auth-launcher/README.md) · [src](./auth-launcher/src/) | `auth` · `jwt` · `rbac` · `express` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · _+1_ | auth-launcher — Scaffold JWT, refresh tokens, RBAC, email verify, and password reset. |
| [backendforgex](./backendforge/) | [README](./backendforge/README.md) · [src](./backendforge/src/) | `backend` · `backendforge` · `cli` · `express` · `generator` · `mern-packages` · `merndev` · `nodejs` · _+4_ | backendforge — Backend automation CLI: scaffold Express modules (router + service stub) so MERN APIs |
| [cacheflowx](./cacheflow/) | [README](./cacheflow/README.md) · [src](./cacheflow/src/) | `cache` · `cacheflow` · `invalidation` · `mern-packages` · `merndev` · `mongodb` · `nodejs` · `npm-pm` · _+3_ | cacheflow — Auto cache invalidation graph: track tag ↔ dependency edges (e.g. Mongo doc ids) and fan |
| [cacheforgex](./cacheforge/) | [README](./cacheforge/README.md) · [src](./cacheforge/src/) | `cache` · `cacheforgex` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · `observability` · `redis` · _+1_ | cacheforgex — Cache entry envelope with TTL + tag list for invalidation. |
| [cachemeshx](./cachemesh/) | [README](./cachemesh/README.md) · [src](./cachemesh/src/) | `cache` · `cachemesh` · `express` · `mern` · `mern-packages` · `merndev` · `middleware` · `nodejs` · _+4_ | Express response caching with TTL, key rules, invalidation, Redis-ready stores. |
...
| [component-usage-scanner](./component-usage-scanner/) | [README](./component-usage-scanner/README.md) · [src](./component-usage-scanner/src/) | `react` · `dead-code` · `audit` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · `typescript` | component-usage-scanner — Find unused React components, hooks, and pages. |
| [configforgex](./configforge/) | [README](./configforge/README.md) · [src](./configforge/src/) | `config` · `configforgex` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · `observability` · `schema` · _+2_ | configforgex — Merge config objects then validate with Zod. |
...
| [ctrlflowx](./ctrlflow/) | [README](./ctrlflow/README.md) · [src](./ctrlflow/src/) | `controller` · `ctrlflowx` · `express` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · `observability` · _+1_ | ctrlflowx — Express controller composer: stack middleware then mount handlers. |
| [dbflowx](./dbflow/) | [README](./dbflow/README.md) · [src](./dbflow/src/) | `dal` · `dbflow` · `mern-packages` · `merndev` · `mongodb` · `nodejs` · `npm-pm` · `observability` · _+2_ | dbflow — Repository façade interface for CRUD-style data access. |
...
| [deploy-template](./deploy-template/) | [README](./deploy-template/README.md) · [src](./deploy-template/src/) | `docker` · `deploy` · `nginx` · `ci` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · _+1_ | deploy-template — Generate Docker, Nginx, PM2, GitHub Actions, and env files for MERN. |
...
| [apiduo](./duoapi/) | [README](./duoapi/README.md) · [src](./duoapi/src/) | `api` · `apiduo` · `graphql` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · `observability` · _+3_ | apiduo — Dual API engine: one Zod resource → GraphQL SDL stub + REST base path metadata. |
| [endpoint-flow](./endpoint-flow/) | [README](./endpoint-flow/README.md) · [src](./endpoint-flow/src/) | `architecture` · `express` · `diagram` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · `typescript` | endpoint-flow — Visualize Express request flow from route → controller → service → database. |
| [env-diff](./env-diff/) | [README](./env-diff/README.md) · [src](./env-diff/src/) | `env` · `config` · `devops` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · `typescript` | env-diff — Compare environment variables across local, staging, and production. |
| [envguardx](./envguard/) | [README](./envguard/README.md) · [src](./envguard/src/) | `ci` · `cli` · `dotenv` · `env` · `envguard` · `environment` · `mern-packages` · `merndev` · _+7_ | Production-safe environment validation system with schema typing, CI checks, and a CLI for missing/i |
...
| [error-translator](./error-translator/) | [README](./error-translator/README.md) · [src](./error-translator/src/) | `errors` · `i18n` · `api` · `express` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · _+1_ | error-translator — Map backend error codes to frontend-friendly user messages automatically. |
...
| [eventmeshx](./eventmesh/) | [README](./eventmesh/README.md) · [src](./eventmesh/src/) | `eventmeshx` · `events` · `mern-packages` · `merndev` · `microservices` · `nodejs` · `npm-pm` · `observability` · _+2_ | Lightweight in-process pub/sub bus with typed helpers — MERN-friendly stepping stone before Redis st |
| [feature-slice-forge](./feature-slice-forge/) | [README](./feature-slice-forge/README.md) · [src](./feature-slice-forge/src/) | `feature` · `vertical-slice` · `scaffold` · `mern` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · _+1_ | feature-slice-forge — Vertical feature-slice scaffolding across MERN (model, routes, hooks, pages, t |
...
| [graphstackx](./graphstack/) | [README](./graphstack/README.md) · [src](./graphstack/src/) | `cli` · `dependencies` · `graph` · `graphstackx` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · _+2_ | graphstackx — CLI to list sorted npm dependencies from package.json (npx graphstackx analyze). |
...
| [hookretryx](./hookretry/) | [README](./hookretry/README.md) · [src](./hookretry/src/) | `hookretryx` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · `observability` · `retry` · `typescript` · _+1_ | hookretryx — Webhook delivery attempt log + backoff helper. |
...
| [jobforgekit](./jobforge/) | [README](./jobforge/README.md) · [src](./jobforge/src/) | `cron` · `jobforgekit` · `jobs` · `mern` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · _+5_ | Background jobs with retries, backoff, schedules, and monitoring hooks for Node. |
| [lesscodekit](./lesscode/) | [README](./lesscode/README.md) · [src](./lesscode/src/) | `cli` · `express` · `lesscodekit` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · `observability` · _+1_ | lesscodekit — Boilerplate CLI: scan files for Express-style `.get/.use` usage. |
...
| [merge-safe](./merge-safe/) | [README](./merge-safe/README.md) · [src](./merge-safe/src/) | `git` · `merge` · `ci` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · `typescript` | merge-safe — Predict likely Git merge conflicts before opening a PR. |
...
| [midflowx](./midflow/) | [README](./midflow/README.md) · [src](./midflow/src/) | `express` · `mern-packages` · `merndev` · `middleware` · `midflowx` · `nodejs` · `npm-pm` · `observability` · _+1_ | midflowx — Compose Express middleware arrays into one handler. |
| [migration-preview](./migration-preview/) | [README](./migration-preview/README.md) · [src](./migration-preview/src/) | `mongodb` · `migration` · `schema` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · `typescript` | migration-preview — Preview Mongo schema migration impact before applying changes. |
| [mockpressx](./mockpress/) | [README](./mockpress/README.md) · [src](./mockpress/src/) | `api` · `express` · `mern-packages` · `merndev` · `mock` · `mockpressx` · `nodejs` · `npm-pm` · _+3_ | Spin up mock Express servers from an existing app’s route table — latency and fake JSON for frontend |
...
| [modstackx](./modstack/) | [README](./modstack/README.md) · [src](./modstack/src/) | `dynamic-import` · `mern-packages` · `merndev` · `modstackx` · `nodejs` · `npm-pm` · `observability` · `plugins` · _+1_ | modstackx — Load `*.plugin.js` modules from a directory via dynamic import. |
| [modulifyx](./modulify/) | [README](./modulify/README.md) · [src](./modulify/src/) | `express` · `mern-packages` · `merndev` · `modules` · `modulifyx` · `nodejs` · `npm-pm` · `observability` · _+3_ | modulifyx — Express modularizer: auto-load route modules from a folder, mount routers, and keep larg |
...
| [monguardx](./monguard/) | [README](./monguard/README.md) · [src](./monguard/src/) | `index` · `mern` · `mern-packages` · `merndev` · `mongodb` · `mongoose` · `monguardx` · `n+1` · _+7_ | Runtime MongoDB query intelligence for Mongoose. Detects slow queries, missing indexes, N+1, duplica |
...
| [package-impact](./package-impact/) | [README](./package-impact/README.md) · [src](./package-impact/src/) | `npm` · `dependencies` · `bundle` · `audit` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · _+1_ | package-impact — Analyze npm dependency impact before install (size, tree, known issues). |
| [pageforgex](./pageforge/) | [README](./pageforge/README.md) · [src](./pageforge/src/) | `api` · `cursor` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · `observability` · `pageforgex` · _+2_ | pageforgex — Cursor + offset pagination helpers for APIs. |
...
| [policyflowx](./policyflow/) | [README](./policyflow/README.md) · [src](./policyflow/src/) | `authorization` · `express` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · `observability` · `permissions` · _+4_ | policyflowx — Auto permission / RBAC helper: role hierarchy, route guards, and simple action strings |
...
| [queryforgex](./queryforge/) | [README](./queryforge/README.md) · [src](./queryforge/src/) | `dashboard` · `filter` · `mern-packages` · `merndev` · `mongodb` · `nodejs` · `npm-pm` · `observability` · _+4_ | queryforgex — Dynamic query builder: turn HTTP query strings into Mongo-style filters, sorts, and pa |
| [queueflowkit](./queueflow/) | [README](./queueflow/README.md) · [src](./queueflow/src/) | `jobs` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · `observability` · `queue` · `queueflowkit` · _+2_ | queueflowkit — Map queue channel names to async handlers with retries. |
...
| [reactstatemesh](./reactstatex/) | [README](./reactstatex/README.md) · [src](./reactstatex/src/) | `express` · `mern-packages` · `merndev` · `mongodb` · `nodejs` · `npm-pm` · `observability` · `reactstatemesh` · _+1_ | Auto-generate React state management from APIs. |
...
| [renderguardx](./renderguard/) | [README](./renderguard/README.md) · [src](./renderguard/src/) | `mern` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · `observability` · `performance` · `profiler` · _+4_ | React render tracking, Profiler wrappers, and hotspots for expensive subtrees. |
...
| [responsax](./responsa/) | [README](./responsa/README.md) · [src](./responsa/src/) | `api` · `envelope` · `error` · `express` · `mern-packages` · `merndev` · `middleware` · `nodejs` · _+8_ | API response standardization middleware for Express — typed envelopes, paginated lists, structured e |
...
| [routecheckx](./routecheck/) | [README](./routecheck/README.md) · [src](./routecheck/src/) | `cli` · `express` · `mern` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · `observability` · _+4_ | Express route discovery and starter API tests, CLI-first MERN workflow. |
...
| [schemagenx](./schemagen/) | [README](./schemagen/README.md) · [src](./schemagen/src/) | `dto` · `mern-packages` · `merndev` · `mongodb` · `nodejs` · `npm-pm` · `observability` · `schema` · _+3_ | schemagenx — Zod object → DTO interface string + field reflection for contracts. |
| [schemauix](./schemaui/) | [README](./schemaui/README.md) · [src](./schemaui/src/) | `form` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · `observability` · `react` · `schema` · _+5_ | schemauix — Validation-to-UI bridge: render a minimal React form from a Zod object schema with share |
| [sdkforgex](./sdkforge/) | [README](./sdkforge/README.md) · [src](./sdkforge/src/) | `cli` · `codegen` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · `observability` · `openapi` · _+3_ | Generate minimal TypeScript fetch clients from OpenAPI 3 path definitions — CI-friendly starter SDKs |
| [sdkpressx](./sdkpress/) | [README](./sdkpress/README.md) · [src](./sdkpress/src/) | `cli` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · `observability` · `openapi` · `sdk` · _+2_ | sdkpress — SDK generator CLI: typed fetch stubs from OpenAPI path keys (`npx sdkpress generate`). |
| [searchforgex](./searchforge/) | [README](./searchforge/README.md) · [src](./searchforge/src/) | `mern-packages` · `merndev` · `mongodb` · `nodejs` · `npm-pm` · `observability` · `search` · `searchforge` · _+1_ | searchforge — Mongo $regex helpers + Atlas $text clause builder. |
| [seedforgex](./seedforge/) | [README](./seedforge/README.md) · [src](./seedforge/src/) | `cli` · `database` · `faker` · `fixtures` · `mern-packages` · `merndev` · `mongodb` · `nodejs` · _+7_ | seedforge — Database seeding kit: deterministic PRNG, ordered seed registrations, and `npx seedforge |
| [serviceforgex](./serviceforge/) | [README](./serviceforge/README.md) · [src](./serviceforge/src/) | `architecture` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · `observability` · `service` · `serviceforge` · _+1_ | serviceforge — Service layer shell with before/after CRUD hooks. |
| [shieldpressx](./shieldpress/) | [README](./shieldpress/README.md) · [src](./shieldpress/src/) | `cli` · `express` · `mern` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · `observability` · _+4_ | Express security static analysis: helmet gaps, injection smells, CORS and auth checks. |
| [stack-sync](./stack-sync/) | [README](./stack-sync/README.md) · [src](./stack-sync/src/) | `contract` · `api` · `drift` · `express` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · _+1_ | stack-sync — Detect contract drift between frontend API clients and Express backend routes. |
| [stacksensex](./stacksense/) | [README](./stacksense/README.md) · [src](./stacksense/src/) | `debugging` · `diagnostic` · `error` · `errors` · `express` · `fingerprint` · `mern-packages` · `merndev` · _+7_ | Smart Express error intelligence: parses stack traces, fingerprints + groups crashes, attaches reque |
| [statemeshx](./statemesh/) | [README](./statemesh/README.md) · [src](./statemesh/src/) | `fsm` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · `observability` · `statemesh` · `typescript` · _+1_ | statemesh — Minimal finite state machine with transitions. |
...
| [testforgekit](./testforge/) | [README](./testforge/README.md) · [src](./testforge/src/) | `cli` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · `observability` · `testforgekit` · `testing` · _+2_ | testforgekit — CLI to emit a starter Vitest file (`npx testforgekit generate`). |
| [transactlyx](./transactly/) | [README](./transactly/README.md) · [src](./transactly/src/) | `mern-packages` · `merndev` · `mongodb` · `nodejs` · `npm-pm` · `observability` · `retry` · `transactions` · _+2_ | transactlyx — Retry wrapper for transactional async work (Mongo session inside callback). |
| [typepressx](./typepress/) | [README](./typepress/README.md) · [src](./typepress/src/) | `api` · `client` · `express` · `mern-packages` · `merndev` · `nodejs` · `npm-pm` · `observability` · _+8_ | Type-safe API framework for Express. Define routes once, get runtime validation, OpenAPI, TypeScript |
